  ...
  <body>
    <div class="container">
        ...
        <div class="row bg-primary-subtle m-1">
            ...
            <div class="col-3"><img src="<?= base_url('images/foto1.jpeg') ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">Maaf</h5>
                      <p class="card-text">Rp. 85.000,-</p>
                      <a href="#" class="btn btn-primary">add to chart</a>
      ...
      <div class="container">
        Copyright 2024. Toko Buku Online Kelas 3B ADITYA RAHMATTULLAH. All Rights Reserved
      </div>
    </footer>
